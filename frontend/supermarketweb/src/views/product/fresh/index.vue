  ...
  <div class="product-container">
    ...
    <el-card class="table-card" shadow="never">
      <el-table v-loading="loading" :data="tableData" style="width: 100%" border stripe>
        ...
        <el-table-column prop="brandName" label="品牌/产地" width="100" show-overflow-tooltip />
    ...
    <el-dialog v-model="dialogVisible" :title="dialogTitle" width="800px" :close-on-click-modal="false" @closed="resetForm">
      <el-form ref="formRef" :model="formData" :rules="formRules" label-width="100px">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="品牌/产地" prop="brandName">
              <el-input v-model="formData.brandName" placeholder="请输入品牌或产地" clearable />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="规格" prop="spec">
              <el-input v-model="formData.spec" placeholder="例：500g/份" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="12">
